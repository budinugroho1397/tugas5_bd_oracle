        ...
        <div class="container-fluid" id="container-wrapper">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <a class='btn btn-primary' href='add_beras.php' ><i class='fa fa-plus'></i> Tambah Data Data Barang</a>
                </div>
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
					...
					$stid = oci_parse($koneksi, 'SELECT * from ITEM_BARANG');
          ...
          $no = 1;
             ...
             <?php echo ($d['HARGA']); ?>
                        ...
                        <td class="td-actions">
						 <a class='btn btn-success' href="edit_barang.php?KODE_BARANG=<?php echo $d["KODE_BARANG"];?>" 
